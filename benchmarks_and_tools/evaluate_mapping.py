...
def evaluate(dataset_path):
    ...
    for sample in dataset:
        report_id = sample.get("report_id", sample.get("id", "Unknown"))
        input_text = sample.get("transcription", sample.get("input_text", ""))
        expected_data = sample.get("expected_output", sample.get("expected_data", {}))
